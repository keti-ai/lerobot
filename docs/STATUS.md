...
**마지막 갱신:** 2026-06-10 (LR replay 게이트 통과 — 데이터=유효 teacher(gripper close 정상 R-46.3/L-54.5, cap/mapping 무관), 잔여=정책 closed-loop grounding. steering 정당. +LS0(시작자세 homing, replay prealign 이 live 에도 유효). Codex "latency 복귀"는 stale 무시)
