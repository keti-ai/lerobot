...
**마지막 갱신:** 2026-06-10 (PIVOT2 — latency(K8~K15) 완료, 잔여=grounding. **Track L = VLA-steering**: perception/IK 거부, α'' 뼈대 유지 + inference-time steering(LS1 envelope+LS2 CFG), 학습 0. denoise 루프 hook(RTC 선례))
