...
APPROVED_SNAPSHOT_ID = "snapshot_20260513_152125"
APPROVED_PROPOSAL_SHA256 = "b600f8380260c21f101453a499325409a460ad9129c5ca38d986df92af86efab"
CONFIRMATION_PHRASE = "SEND_STAGE40_RIGHT_ARM_SERVED_PROPOSAL_ONCE_20260513_152125"
RIGHT_PORT = "can1"
DRIFT_LIMIT_DEG = 1.0
DELTA_LIMIT_DEG = 2.0
TARGET_TABLE = [
    {
        ...
        "proposal_current_deg": -3.835892677307129,
        "proposal_deg": -4.051617622375488,
        "proposal_delta_deg": -0.21572494506835938,
        "target_deg": -4.051617622375488,
        "target_delta_from_proposal_current_deg": -0.21572494506835938,
    },
    {
        "key": "right_joint_2.pos",
        "proposal_current_deg": 0.6666366457939148,
        "proposal_deg": 1.116877794265747,
        "proposal_delta_deg": 0.4502411484718323,
        "target_deg": 1.116877794265747,
        "target_delta_from_proposal_current_deg": 0.4502411484718323,
    },
    {
        "key": "right_joint_3.pos",
        "proposal_current_deg": 14.676934242248535,
        "proposal_deg": 15.215548515319824,
        "proposal_delta_deg": 0.5386142730712891,
        "target_deg": 15.215548515319824,
        "target_delta_from_proposal_current_deg": 0.5386142730712891,
    },
    {
        "key": "right_joint_4.pos",
        "proposal_current_deg": 6.677294731140137,
        "proposal_deg": 8.166449546813965,
        "proposal_delta_deg": 1.4891548156738281,
        "target_deg": 8.166449546813965,
        "target_delta_from_proposal_current_deg": 1.4891548156738281,
    },
    {
        "key": "right_joint_5.pos",
        "proposal_current_deg": -3.529895544052124,
        "proposal_deg": -3.6858556270599365,
        "proposal_delta_deg": -0.1559600830078125,
        "target_deg": -3.6858556270599365,
        "target_delta_from_proposal_current_deg": -0.1559600830078125,
    },
    {
        "key": "right_joint_6.pos",
        "proposal_current_deg": 4.863168716430664,
        "proposal_deg": 4.412115097045898,
        "proposal_delta_deg": -0.4510536193847656,
        "target_deg": 4.412115097045898,
        "target_delta_from_proposal_current_deg": -0.4510536193847656,
    },
    {
        "key": "right_joint_7.pos",
        "proposal_current_deg": -1.2567739486694336,
        "proposal_deg": -1.373927116394043,
        "proposal_delta_deg": -0.11715316772460938,
        "target_deg": -1.373927116394043,
        "target_delta_from_proposal_current_deg": -0.11715316772460938,
    },
]
...
def write_markdown(path: Path, payload: dict[str, Any]) -> None:
    lines = [
        "# Stage 40 Guarded Served Proposal Write",
        "",
        "## Status",
        "",
    ...
    lines.append("This artifact records a Stage 40 write attempt." if payload["actuator_commands_sent"] else "No actuator command was sent by this run.")
    path.write_text("\n".join(lines) + "\n")


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Stage 40 guarded write from A6000 served proposal.")
...
def main() -> int:
    ...
    payload: dict[str, Any] = {
        ...
        "mode": "stage40_guarded_served_proposal_write",
