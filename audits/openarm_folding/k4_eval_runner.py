...
PROFILES: dict[str, ProfileSpec] = {
    ...
    # ★ TUNED (2026-06-12, operator-selected): wrist (j5/6/7) kp x1.8 + rest x1.3.
    # Best-feel gains from the D07t gain sweep. Use this as the default TS1 profile.
    "traj_trap_100_v120_kp18x13x": ProfileSpec(
        action_interpolation_multiplier=1,
        use_relative_cap=False,
        trajectory_streamer_hz=100,
        trajectory_profile="trapezoidal",
    ...
    "traj_trap_100_v120_kp2x14x": ProfileSpec(
        ...
        position_kp=[336.0, 336.0, 336.0, 336.0, 48.0, 62.0, 50.0, 35.0],
        clamp_log_suppression="all",
        write_diagnostic_csv=True,
    ),
